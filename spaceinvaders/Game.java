...
public class Game extends Canvas {
	...
	private boolean jump = false; // true if up arrow key currently pressed
	...
	public Game() {
		...
		JFrame container = new JFrame("Change the letter of the main window");
	...
	public void notifyDeath() {
		message = "Change the message notification";
